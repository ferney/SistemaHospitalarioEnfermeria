...
require_once("include/liquidos_eliminados_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "liquidos_eliminados" );
