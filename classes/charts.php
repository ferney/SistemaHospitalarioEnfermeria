...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("actividades" == $this->chrt_array['tables'][0])
			return true;
		if("antecedentes" == $this->chrt_array['tables'][0])
			return true;
		if("balance_hidrico" == $this->chrt_array['tables'][0])
			return true;
		if("detalle_subactividad" == $this->chrt_array['tables'][0])
			return true;
		if("escala_correccion" == $this->chrt_array['tables'][0])
			return true;
		if("liquidos_administrados" == $this->chrt_array['tables'][0])
			return true;
		if("liquidos_eliminados" == $this->chrt_array['tables'][0])
			return true;
		if("medicamentos" == $this->chrt_array['tables'][0])
			return true;
		if("pacientes" == $this->chrt_array['tables'][0])
			return true;
		if("signos_vitales" == $this->chrt_array['tables'][0])
			return true;
		if("subactividades" == $this->chrt_array['tables'][0])
			return true;
		if("tarjeta_medicamentos_completa" == $this->chrt_array['tables'][0])
			return true;
		if("registros_glucometria" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
