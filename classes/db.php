...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "basedatosenfermeriaatlocalhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "actividades", "varname" => "basedatosenfermeriaatlocalhost__actividades", "altvarname" => "actividades", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
			$dalTables[$conn->connId][] = array("name" => "antecedentes", "varname" => "basedatosenfermeriaatlocalhost__antecedentes", "altvarname" => "antecedentes", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
			$dalTables[$conn->connId][] = array("name" => "balance_hidrico", "varname" => "basedatosenfermeriaatlocalhost__balance_hidrico", "altvarname" => "balance_hidrico", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
			$dalTables[$conn->connId][] = array("name" => "detalle_subactividad", "varname" => "basedatosenfermeriaatlocalhost__detalle_subactividad", "altvarname" => "detalle_subactividad", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
			$dalTables[$conn->connId][] = array("name" => "escala_correccion", "varname" => "basedatosenfermeriaatlocalhost__escala_correccion", "altvarname" => "escala_correccion", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
			$dalTables[$conn->connId][] = array("name" => "liquidos_administrados", "varname" => "basedatosenfermeriaatlocalhost__liquidos_administrados", "altvarname" => "liquidos_administrados", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
			$dalTables[$conn->connId][] = array("name" => "liquidos_eliminados", "varname" => "basedatosenfermeriaatlocalhost__liquidos_eliminados", "altvarname" => "liquidos_eliminados", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
			$dalTables[$conn->connId][] = array("name" => "medicamentos", "varname" => "basedatosenfermeriaatlocalhost__medicamentos", "altvarname" => "medicamentos", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
			$dalTables[$conn->connId][] = array("name" => "pacientes", "varname" => "basedatosenfermeriaatlocalhost__pacientes", "altvarname" => "pacientes", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
			$dalTables[$conn->connId][] = array("name" => "registros_glucometria", "varname" => "basedatosenfermeriaatlocalhost__registros_glucometria", "altvarname" => "registros_glucometria", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
			$dalTables[$conn->connId][] = array("name" => "signos_vitales", "varname" => "basedatosenfermeriaatlocalhost__signos_vitales", "altvarname" => "signos_vitales", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
			$dalTables[$conn->connId][] = array("name" => "subactividades", "varname" => "basedatosenfermeriaatlocalhost__subactividades", "altvarname" => "subactividades", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
			$dalTables[$conn->connId][] = array("name" => "tarjeta_medicamentos_completa", "varname" => "basedatosenfermeriaatlocalhost__tarjeta_medicamentos_completa", "altvarname" => "tarjeta_medicamentos_completa", "connId" => "basedatosenfermeriaatlocalhost", "schema" => "", "connName" => "base_datos_enfermeria at local");
		}
	}
