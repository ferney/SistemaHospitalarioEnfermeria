...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "basedatosenfermeriaatlocalhost";
		}
		return $connId;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "actividades" ] = array( "url" => "actividades", "type" => 0 );
	$projectEntitiesReverse[ "actividades" ] = "actividades";
	$projectEntities[ "antecedentes" ] = array( "url" => "antecedentes", "type" => 0 );
	$projectEntitiesReverse[ "antecedentes" ] = "antecedentes";
	$projectEntities[ "balance_hidrico" ] = array( "url" => "balance_hidrico", "type" => 0 );
	$projectEntitiesReverse[ "balance_hidrico" ] = "balance_hidrico";
	$projectEntities[ "detalle_subactividad" ] = array( "url" => "detalle_subactividad", "type" => 0 );
	$projectEntitiesReverse[ "detalle_subactividad" ] = "detalle_subactividad";
	$projectEntities[ "escala_correccion" ] = array( "url" => "escala_correccion", "type" => 0 );
	$projectEntitiesReverse[ "escala_correccion" ] = "escala_correccion";
	$projectEntities[ "liquidos_administrados" ] = array( "url" => "liquidos_administrados", "type" => 0 );
	$projectEntitiesReverse[ "liquidos_administrados" ] = "liquidos_administrados";
	$projectEntities[ "liquidos_eliminados" ] = array( "url" => "liquidos_eliminados", "type" => 0 );
	$projectEntitiesReverse[ "liquidos_eliminados" ] = "liquidos_eliminados";
	$projectEntities[ "medicamentos" ] = array( "url" => "medicamentos", "type" => 0 );
	$projectEntitiesReverse[ "medicamentos" ] = "medicamentos";
	$projectEntities[ "pacientes" ] = array( "url" => "pacientes", "type" => 0 );
	$projectEntitiesReverse[ "pacientes" ] = "pacientes";
	$projectEntities[ "signos_vitales" ] = array( "url" => "signos_vitales", "type" => 0 );
	$projectEntitiesReverse[ "signos_vitales" ] = "signos_vitales";
	$projectEntities[ "subactividades" ] = array( "url" => "subactividades", "type" => 0 );
	$projectEntitiesReverse[ "subactividades" ] = "subactividades";
	$projectEntities[ "tarjeta_medicamentos_completa" ] = array( "url" => "tarjeta_medicamentos_completa", "type" => 0 );
	$projectEntitiesReverse[ "tarjeta_medicamentos_completa" ] = "tarjeta_medicamentos_completa";
	$projectEntities[ "registros_glucometria" ] = array( "url" => "registros_glucometria", "type" => 0 );
	$projectEntitiesReverse[ "registros_glucometria" ] = "registros_glucometria";
}
