...
require_once("include/liquidos_administrados_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "liquidos_administrados" );
