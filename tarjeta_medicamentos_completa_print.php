...
require_once("include/tarjeta_medicamentos_completa_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "tarjeta_medicamentos_completa" );
