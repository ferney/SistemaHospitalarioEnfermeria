...
require_once("include/detalle_subactividad_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "detalle_subactividad" );
