...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "basedatosenfermeriaatlocalhost" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["actividades"] = "basedatosenfermeriaatlocalhost";
		$connectionsIds["antecedentes"] = "basedatosenfermeriaatlocalhost";
		$connectionsIds["balance_hidrico"] = "basedatosenfermeriaatlocalhost";
		$connectionsIds["detalle_subactividad"] = "basedatosenfermeriaatlocalhost";
		$connectionsIds["escala_correccion"] = "basedatosenfermeriaatlocalhost";
		$connectionsIds["liquidos_administrados"] = "basedatosenfermeriaatlocalhost";
		$connectionsIds["liquidos_eliminados"] = "basedatosenfermeriaatlocalhost";
		$connectionsIds["medicamentos"] = "basedatosenfermeriaatlocalhost";
		$connectionsIds["pacientes"] = "basedatosenfermeriaatlocalhost";
		$connectionsIds["signos_vitales"] = "basedatosenfermeriaatlocalhost";
		$connectionsIds["subactividades"] = "basedatosenfermeriaatlocalhost";
		$connectionsIds["tarjeta_medicamentos_completa"] = "basedatosenfermeriaatlocalhost";
		$connectionsIds["registros_glucometria"] = "basedatosenfermeriaatlocalhost";
