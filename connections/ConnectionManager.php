...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "basedatosenfermeriaatlocalhost";
		$data["connName"] = "base_datos_enfermeria at local";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;3306;base_datos_enfermeria;;1"; //currently unused

		$this->_connectionsIdByName["base_datos_enfermeria at local"] = "basedatosenfermeriaatlocalhost";
		...
		$data["connInfo"][4] = "base_datos_enfermeria";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Port=3306;Database=base_datos_enfermeria;OPTION=3";
		// encription set
		...
		$connectionsData["basedatosenfermeriaatlocalhost"] = $data;
